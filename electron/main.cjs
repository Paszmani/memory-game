/**
 * Processo principal do Electron — casca desktop do Jogo da Memória.
 *
 ...
 * GitHub Pages (`/memory-game/...`), o que inviabiliza `loadFile`/file://.
 ...
 *  Distinta da da Roleta (39217) para não colidirem se ambos abrirem. */
const PORT = 39218;
